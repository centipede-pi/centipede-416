...
else                           $display = 0;                          // .... .... .... ..1.   use web kit to rotate meter element in iframe, and meter width = 45px
?>                                                                    
<!doctype html>
<html lang="en">
<head>
...
while( $row = mysql_fetch_object( $rs ) ) {
   ...
   echo ("<iframe id='$id' src='iframe.php?board=$row->board&channel=$row->channel&type=$type&display=$display'></iframe>\n");
   echo("</td>");
   if(( $display & 1 ) || ( $even == 0 )) echo "</tr>";
   $even ^= 1;
   }
